...
import { app } from '../index'; // Importa la aplicación desde index.ts

// Resetear el estado de los usuarios antes de cada prueba
// beforeEach(() => {
//     // Reiniciar la base de datos en memoria
//     app.store.users = [
